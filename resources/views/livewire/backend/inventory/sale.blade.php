                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" class="form-control"
                                            wire:model.debounce.500ms="product_quantity.{{$key}}" style="width: 100px;" placeholder="Quantity" step="any">
                                    </td>
                                    <td>
                                        <input type="text" class="form-control"
                                            wire:model.debounce.500ms="product_rate.{{$key}}" placeholder="Sale Rate">
                                    </td>
                                    {{-- <td>
                                        <input type="text" class="form-control"
                                    ...
                                    <td>
                                        <center><a href="#" class="btn btn-danger btn-sm"
                                                wire:click="removeProduct({{$key}},{{$product['id']}})"><i class="fa fa-trash"></i></a>
                                        </center>
                                    </td>
                                </tr>
                    ...
                    <div class="col-lg-4">
                        <div wire:ignore class="form-group">
                            ...
                            <select class="form-control" wire:model.lazy="contact_id" id="select2-dropdown">
                                ...
                                <option value="{{ $contact->id }}">{{ $contact->business_name }}-{{ $contact->first_name }} {{ $contact->last_name
                                    }}</option>
                                @endforeach
                            </select>
