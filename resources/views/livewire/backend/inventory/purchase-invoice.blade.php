        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    {{-- <div class="table table-bordered" style="border: 2px solid black;">
                                ...
                                <td>
                                    <div class="col-sm-6">
                                        <address>
                                            ...
                                            Email: {{$PurchaseInvoice->Contact->email}} {{$PurchaseInvoice->Contact->email}}<br/>
                                            Phone: {{$PurchaseInvoice->Contact->phone}}<br>
                                            User Type: {{$PurchaseInvoice->Contact->type}}
                                        </address>
                                    </div>
                                </td>
