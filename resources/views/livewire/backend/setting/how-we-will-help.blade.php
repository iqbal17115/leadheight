                        ...
                        <div class="col-sm-8">
                            <div class="text-sm-right">
                                <button type="button"
                                    ...
                                    wire:click="howWeWillHelpModal"><i class="mdi mdi-plus mr-1"></i> New How We Will Help</button>
                            </div>
                        </div><!-- end col-->
                    </div>
                    <div wire:ignore class="table-responsive">
                        <div wire:ignore class="table-responsive">
                            <table class="table table-bordered dt-responsive nowrap" id="sliderTable"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title mt-0" id="myLargeModalLabel">How We Will Help</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form wire:submit.prevent="howWeWillHelpSave">
...
<script>
    function callEdit(id) {
        @this.call('howWeWillHelpEdit', id);
    }
    function callDelete(id) {
        ...
        $(document).ready(function () {
            var datatable = $('#sliderTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{route('data.how_we_will_help_table')}}",
                columns: [
                    {
                        title: 'SL',
                        data: 'id'
