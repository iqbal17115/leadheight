                        ...
                        <div class="col-sm-8">
                            <div class="text-sm-right">
                                <button type="button"
                                    ...
                                    wire:click="affiliationModal"><i class="mdi mdi-plus mr-1"></i> New Affiliation</button>
                            </div>
                        </div><!-- end col-->
                    </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title mt-0" id="myLargeModalLabel">Affiliation</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form wire:submit.prevent="affiliationSave">
