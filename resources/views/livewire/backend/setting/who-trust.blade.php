                        ...
                        <div class="col-sm-8">
                            <div class="text-sm-right">
                                <button type="button"
                                    ...
                                    wire:click="whoTrustModal"><i class="mdi mdi-plus mr-1"></i> New Who Trust</button>
                            </div>
                        </div><!-- end col-->
                    </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title mt-0" id="myLargeModalLabel">Who Trust</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form wire:submit.prevent="whoTrustSave">
    ...
    function callDelete(id) {
        ...
        $(document).ready(function () {
            var datatable = $('#sliderTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{route('data.who_trust_table')}}",
                columns: [
                    {
                        title: 'SL',
                        data: 'id'
