...
<div>
    <style>
        ...
        @import url('https://fonts.googleapis.com/css2?family=Georama:wght@200&family=Oswald:wght@200&display=swap');
    ...
    <main>
        <div class="container">
             {{-- <h1 style="text-align: center">Order Tracking information</h1>
            <div class="track">
